...
{
    private readonly ReadStoreConnection _dbConnection = dbConnection;
    private IDbConnection Connection => _dbConnection.GetConnection();
    private IDbTransaction Transaction => _dbConnection.GetTransaction();
